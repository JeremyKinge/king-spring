 ...
 */
//专人干专事
public class KHandlerAdapter {

    private Map<String,Integer> paramMapping;

    public KHandlerAdapter(Map<String,Integer> paramMapping){
     ...
     * @return
     */
    public KModelAndView handle(HttpServletRequest req, HttpServletResponse resp, KHandlerMapping handler) throws  Exception {
        ...
        boolean isModelAndView = handler.getMethod().getReturnType() == KModelAndView.class;
        if(isModelAndView){
            return (KModelAndView)result;
        }else{
            return null;
        }
    }
