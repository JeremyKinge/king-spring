...
//
//        /** 我们自己会实现 */
//        //KHandlerMapping 用来保存Controller中配置的RequestMapping和Method的一个对应关系
...
//                    this.handlerMappings.add(new KHandlerMapping(pattern, controller, method));
...
//
//        for (KHandlerMapping handlerMapping : this.handlerMappings){
//
...
//
//
//            this.handlerAdapters.put(handlerMapping,new KHandlerAdapter(paramMapping));
//        }
//
//    }
//
...
//            this.viewResolvers.add(new KViewResolver(template.getName(),template));
//        }
//
//    }
//
...
////        KHandlerMapping handler = handlerMapping.get(url);
//
////        try {
////            KModelAndView mv = (KModelAndView)handler.getMethod().invoke(handler.getController());
...
//            KHandlerMapping handler = getHandler(req);
//            if(handler == null){
//                resp.getWriter().write("<font size='25' color='red'>404 Not Found</font><br/><font color='green'><i>Copyright@GupaoEDU</i></font>");
//                return;
//            }
//
//            KHandlerAdapter ha = getHandlerAdapter(handler);
//
//
//            //这一步只是调用方法，得到返回值
//            KModelAndView mv = ha.handle(req, resp, handler);
//
//
//            //这一步才是真的输出
...
//    }
//
//    private void processDispatchResult(HttpServletResponse resp, KModelAndView mv) throws Exception {
//        //调用viewResolver的resolveView方法
//        if(null == mv){ return;}
//
//        if(this.viewResolvers.isEmpty()){ return;}
//
//        for (KViewResolver viewResolver: this.viewResolvers) {
//
...
//    }
//
//    private KHandlerAdapter getHandlerAdapter(KHandlerMapping handler) {
//        if(this.handlerAdapters.isEmpty()){return  null;}
//        return this.handlerAdapters.get(handler);
//    }
//
//    private KHandlerMapping getHandler(HttpServletRequest req) {
//
...
//        url = url.replace(contextPath,"").replaceAll("/+","/");
//
//        for (KHandlerMapping handler : this.handlerMappings) {
